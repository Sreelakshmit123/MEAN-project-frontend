...
/////////////////imported from browser Html code////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // paypal  creation // code from browser - npm i ngx-paypal -Creating orders on client
  private initConfig(): void {
    this.payPalConfig = {
        ...
        onClientAuthorization: (data) => {
            ...
            // steps to follow transaction completed successfully
            this.api.emptyCartAPI().subscribe((res:any)=>{
              this.api.getCartCount()
              this.toaster.success("Successfully completed the payment... ThankYou for Purchasing with Us")
